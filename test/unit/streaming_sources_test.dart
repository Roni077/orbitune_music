...
void main() {
  ...
  group('SearchRepository Stream Resolver Tests', () {
    ...
    test('Resolves fallback stream URL when provided on track', () async {
      final track = Track(
        id: 'direct_1',
        title: 'Direct Stream Track',
        artist: 'Artist',
        streamUrl: 'https://example.com/direct_audio.opus',
        source: 'extractor',
      );

      final streamUrl = await repository.resolveStreamUrl(track, quality: AudioQuality.high320k);
